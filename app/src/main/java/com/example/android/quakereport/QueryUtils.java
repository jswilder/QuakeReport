    ...
    public static ArrayList<EarthQuakeData> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0; i<features.length(); i++){
                ...
                Double mag = properties.optDouble("mag",1.1);
                String city = properties.optString("place","Zimbabwe");
                Long time = properties.optLong("time",1505336673);
                String url = properties.optString("url","https://google.com");

                earthquakes.add(new EarthQuakeData(city,mag,time,url));
            }
